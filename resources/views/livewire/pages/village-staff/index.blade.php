<div>
    ...
    @livewire('utils.filter', ['table' => 'pages.village-staff.section.table', 'positionType' => $option->id, 'useStatusData' => true, 'useArea' => true, 'usePositionType' => true, 'usePositionStatus' => true])
