            ...
            @foreach ($permissions as $item)
                <li class="flex items-center justify-between gap-x-6 py-5">
                    ...
                    <div class="flex flex-none items-center gap-x-2">
                        <a
                            onclick="Livewire.dispatch('openModal', { component: 'modals.form-permission', arguments: {id: {{ $item->id }}} })"class="inline-flex rounded-lg p-2 bg-purple-50 text-purple-700 ring-4 ring-white">
