    ...
    <div x-data="{
        ...
        <div class="flex items-center border-b border-gray-200 pb-2">
            ...
            <button class="ml-auto p-2 focus:outline-none">
                <a x-show="activeTab === 'identity'"
                    wire:click="$dispatchTo('pages.profile.section.header','download', {id: 'absadjhsda'})">
        ...
        <div class="p-4 bg-white">
            @if ($tabActive == 'identity')
                <livewire:pages.profile.section.form :$form :$staff />
            @endif

            @if ($tabActive == 'history')
                <livewire:pages.village-staff-history.section.table :$form :$staff />
